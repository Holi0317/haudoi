/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e92f74908cebf1c9c6a5b2f2b99bf1fe)
// Runtime types generated with workerd@1.20260116.0 2025-11-20 enable_request_signal
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StorageDO" | "TokenRefreshDO" | "ImportDO";
	}
	interface Env {
		KV: KVNamespace;
		GH_CLIENT_ID: string;
		...
		STORAGE: DurableObjectNamespace<import("./src/index").StorageDO>;
		TOKEN_REFRESH: DurableObjectNamespace<import("./src/index").TokenRefreshDO>;
		IMPORT_DO: DurableObjectNamespace<import("./src/index").ImportDO>;
